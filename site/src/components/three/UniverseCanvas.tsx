...
export function UniverseFallback() {
  return (
    <div className="absolute inset-0 overflow-hidden">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_70%_60%_at_50%_38%,rgba(212,175,55,0.09),rgba(5,6,10,0)_70%)]" aria-hidden="true" />
      ...
      <div className="animate-float-y absolute right-[6%] top-[14%] hidden w-[300px] opacity-80 lg:block" aria-hidden="true">
        <svg viewBox="0 0 200 200" className="block w-full">
          <circle cx="100" cy="100" r="82" fill="rgba(10,12,17,0.6)" stroke="#d4af37" strokeWidth="1.6" />
          <g stroke="rgba(212,175,55,0.45)" fill="none">
      ...
      <div className="animate-float-y absolute left-[4%] top-[52%] hidden w-[300px] opacity-80 lg:block" style={{ animationDelay: '2s' }} aria-hidden="true">
        <svg viewBox="0 0 200 200" className="block w-full">
          <circle cx="100" cy="100" r="9" fill="#d4af37" opacity="0.9" />
          <g stroke="rgba(212,175,55,0.5)" strokeWidth="1.2" fill="none">
          ...
          <circle cx="40" cy="40" r="7" fill="#e9c65a" />
          <circle cx="160" cy="42" r="7" fill="#ef4444" />
          <circle cx="172" cy="112" r="7" fill="#e9c65a" />
          <circle cx="125" cy="168" r="7" fill="#ef4444" />
          <circle cx="58" cy="158" r="7" fill="#e9c65a" />
          <circle cx="24" cy="104" r="7" fill="#ef4444" />
        </svg>
      </div>

      {/* Floating dots */}
      {['left-[8%] top-[20%] size-[5px] bg-gold-500', 'left-[86%] top-[40%] size-[4px] bg-crimson-500', 'left-[30%] top-[12%] size-[4px] bg-gold-500', 'left-[72%] top-[72%] size-[5px] bg-crimson-500'].map((c, i) => (
