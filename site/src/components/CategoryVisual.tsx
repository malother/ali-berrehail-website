...
const GRAPHITE = '#434850'
const IVORY = '#f8fafc'
const ELEC = '#3f7ee8'
const ELEC_LIGHT = '#6f9ef0'
const ELEC_PALE = '#a8c4f5'
const CRIMSON = '#a32020'
const CRIMSON_LIGHT = '#c23a3a'

function Frame({ id, tone, children }: { id: string; tone: 'elec' | 'crimson'; children: ReactNode }) {
  const accent = tone === 'elec' ? ELEC : CRIMSON
  const accentLight = tone === 'elec' ? ELEC_LIGHT : CRIMSON_LIGHT
  return (
    <svg viewBox="0 0 400 300" className="size-full" aria-hidden="true" preserveAspectRatio="xMidYMid slice">
      <defs>
        <radialGradient id={`bg-${id}`} cx="50%" cy="40%" r="78%">
          ...
          <stop offset="72%" stopColor="#10141a" />
          <stop offset="100%" stopColor="#161b23" />
        </radialGradient>
...
export default function CategoryVisual({ id }: { id: CategoryId }) {
  switch (id) {
    ...
    case 'olive-oil':
      return (
        <Frame id={id} tone="elec">
          {/* oil bottle */}
          <rect x="168" y="78" width="64" height="148" rx="16" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2.5" />
          <rect x="192" y="46" width="16" height="36" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2.5" />
          <rect x="186" y="36" width="28" height="14" rx="4" fill={ELEC} />
          {/* label */}
          <rect x="182" y="128" width="36" height="46" rx="6" fill={IVORY} stroke={ELEC} strokeWidth="2" />
          <circle cx="200" cy="146" r="9" fill="none" stroke={ELEC} strokeWidth="2" />
          {/* olives + dish */}
          <g>
          ...
          <ellipse cx="270" cy="233" rx="24" ry="8" fill={ELEC_LIGHT} />
        </Frame>
      )
    case 'coffee':
      return (
        <Frame id={id} tone="elec">
          ...
          <path d="M126 108 v-18 q0 -10 18 -10 h12 q18 0 18 10 v18" fill="#10141a" stroke={GRAPHITE} strokeWidth="2.5" />
          <path d="M126 128 l26 22 m26 -22 l-26 22 m26 22 l-26 22 m-26 -22 l26 -22 m0 44 l-26 -22" stroke={ELEC} strokeWidth="2" strokeLinecap="round" />
          {/* cup */}
          <path d="M222 150 h92 l-12 62 a26 26 0 0 1 -26 22 h-16 a26 26 0 0 1 -26 -22 Z" fill={IVORY} stroke={GRAPHITE} strokeWidth="2.5" />
          <ellipse cx="268" cy="150" rx="46" ry="10" fill={ELEC} />
          ...
          {/* beans */}
          <ellipse cx="186" cy="228" rx="12" ry="7" transform="rotate(24 186 228)" fill={ELEC} stroke={GRAPHITE} strokeWidth="1.6" />
          <ellipse cx="212" cy="240" rx="11" ry="6" transform="rotate(-18 212 240)" fill={ELEC_LIGHT} stroke={GRAPHITE} strokeWidth="1.6" />
          <ellipse cx="238" cy="252" rx="10" ry="6" transform="rotate(30 238 252)" fill={ELEC} stroke={GRAPHITE} strokeWidth="1.6" />
          {/* steam */}
          <path d="M246 118 q-8 -12 4 -20 q10 -6 -2 -16" fill="none" stroke={ELEC_LIGHT} strokeWidth="3" strokeLinecap="round" />
          <path d="M272 112 q-8 -12 4 -20 q10 -6 -2 -16" fill="none" stroke={ELEC} strokeWidth="3" strokeLinecap="round" />
        </Frame>
      )
    case 'spices':
      return (
        <Frame id={id} tone="elec">
          <Bowl cx="122" cy="196" rx="54" ry="20" fill={ELEC} stroke={GRAPHITE} />
          <ellipse cx="122" cy="196" rx="54" ry="20" fill={ELEC_LIGHT} stroke="none" />
          <circle cx="104" cy="186" r="7" fill={ELEC_PALE} />
          <circle cx="132" cy="190" r="7" fill={ELEC_PALE} />
          <circle cx="144" cy="200" r="6" fill={ELEC_PALE} />
          <Bowl cx="200" cy="228" rx="58" ry="20" fill={ELEC} stroke={GRAPHITE} />
          ...
          <Bowl cx="292" cy="206" rx="46" ry="17" fill={ELEC} stroke={GRAPHITE} />
          ...
          {/* scattered */}
          <circle cx="120" cy="132" r="3" fill={ELEC} />
          <circle cx="162" cy="122" r="3" fill={CRIMSON} />
          <circle cx="216" cy="136" r="3" fill={ELEC} />
          <circle cx="278" cy="146" r="3" fill={CRIMSON} />
          <circle cx="318" cy="128" r="3" fill={ELEC} />
          <circle cx="180" cy="158" r="2.4" fill={ELEC} />
          <circle cx="252" cy="162" r="2.4" fill={CRIMSON} />
          <circle cx="306" cy="168" r="2.4" fill={ELEC} />
        </Frame>
      )
    case 'nuts':
      return (
        <Frame id={id} tone="elec">
          <Bowl cx="206" cy="212" rx="96" ry="30" fill={ELEC} stroke={GRAPHITE} />
          <ellipse cx="206" cy="212" rx="96" ry="30" fill={ELEC_PALE} stroke="none" />
          {/* almonds */}
          <ellipse cx="160" cy="178" rx="26" ry="13" transform="rotate(-24 160 178)" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2" />
          <ellipse cx="214" cy="170" rx="24" ry="12" transform="rotate(12 214 170)" fill={IVORY} stroke={GRAPHITE} strokeWidth="2" />
          <ellipse cx="258" cy="182" rx="24" ry="12" transform="rotate(-8 258 182)" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2" />
          <ellipse cx="188" cy="196" rx="22" ry="11" transform="rotate(26 188 196)" fill={IVORY} stroke={GRAPHITE} strokeWidth="2" />
          {/* walnuts */}
          <circle cx="238" cy="200" r="15" fill={ELEC} stroke={GRAPHITE} strokeWidth="2" />
          <path d="M228 196 q10 10 20 0" fill="none" stroke={GRAPHITE} strokeWidth="1.6" />
          <circle cx="272" cy="204" r="13" fill={ELEC_LIGHT} stroke={GRAPHITE} strokeWidth="2" />
          <path d="M264 200 q8 8 16 0" fill="none" stroke={GRAPHITE} strokeWidth="1.6" />
          <circle cx="150" cy="200" r="13" fill={ELEC_LIGHT} stroke={GRAPHITE} strokeWidth="2" />
          {/* hazelnuts */}
          <ellipse cx="178" cy="228" rx="12" ry="8" transform="rotate(-14 178 228)" fill={ELEC} stroke={GRAPHITE} strokeWidth="1.8" />
          <ellipse cx="226" cy="232" rx="12" ry="8" transform="rotate(18 226 232)" fill={ELEC} stroke={GRAPHITE} strokeWidth="1.8" />
        </Frame>
      )
    case 'dried-fruits':
      return (
        <Frame id={id} tone="elec">
          ...
          <ellipse cx="202" cy="206" rx="104" ry="34" fill="none" stroke={ELEC} strokeWidth="1.5" />
          {/* apricots */}
          <circle cx="152" cy="178" r="17" fill={ELEC} stroke={GRAPHITE} strokeWidth="2" />
          <path d="M152 178 q-4 -8 4 -10 q8 -2 6 8" fill={ELEC_LIGHT} stroke="none" />
          <circle cx="176" cy="192" r="14" fill={ELEC_LIGHT} stroke={GRAPHITE} strokeWidth="2" />
          <circle cx="204" cy="178" r="15" fill={ELEC} stroke={GRAPHITE} strokeWidth="2" />
          {/* figs */}
    ...
    case 'grains':
      return (
        <Frame id={id} tone="elec">
          ...
          <path d="M146 142 v-16 q0 -10 18 -10 h16 q18 0 18 10 v16" fill="#10141a" stroke={GRAPHITE} strokeWidth="2.5" />
          <path d="M146 170 l30 26 m30 -26 l-30 26 m30 26 l-30 26 m-30 -26 l30 -26 m0 52 l-30 -26" stroke={ELEC} strokeWidth="2" strokeLinecap="round" />
          {/* wheat */}
          <g stroke={GRAPHITE} strokeWidth="2" fill="none">
            <path d="M296 236 q-2 -58 -4 -104" />
            <path d="M300 236 q2 -58 4 -104" />
            <path d="M298 136 q-26 -4 -20 -20 q8 8 20 8" fill={ELEC} />
            <path d="M298 156 q-28 -2 -22 -18 q8 8 22 8" fill={ELEC} />
            <path d="M298 176 q-28 -2 -22 -18 q8 8 22 8" fill={ELEC} />
            <path d="M300 138 q24 -4 18 -20 q-8 8 -18 8" fill={ELEC} />
            <path d="M300 158 q26 -2 20 -18 q-8 8 -20 8" fill={ELEC} />
            <path d="M300 178 q26 -2 20 -18 q-8 8 -20 8" fill={ELEC} />
            <path d="M298 206 q-24 2 -20 16 q8 -6 20 -6" fill={ELEC} />
            <path d="M300 206 q24 2 20 16 q-8 -6 -20 -6" fill={ELEC} />
          </g>
          <circle cx="176" cy="238" r="4" fill={ELEC} />
          <circle cx="206" cy="244" r="4" fill={ELEC} />
          <circle cx="238" cy="238" r="4" fill={ELEC} />
        </Frame>
      )
    case 'legumes':
      return (
        <Frame id={id} tone="elec">
          <Bowl cx="118" cy="196" rx="52" ry="19" fill={ELEC} stroke={GRAPHITE} />
          <ellipse cx="118" cy="196" rx="52" ry="19" fill={ELEC_PALE} stroke="none" />
          <circle cx="100" cy="188" r="6" fill={ELEC_LIGHT} />
          <circle cx="122" cy="192" r="6" fill={ELEC_LIGHT} />
          <circle cx="138" cy="200" r="5.5" fill={ELEC_LIGHT} />
          <Bowl cx="206" cy="224" rx="60" ry="20" fill={ELEC} stroke={GRAPHITE} />
          ...
          <Bowl cx="296" cy="196" rx="46" ry="17" fill={ELEC} stroke={GRAPHITE} />
          ...
          <path d="M96 136 q6 8 0 16" stroke={ELEC} strokeWidth="2.4" fill="none" strokeLinecap="round" />
          <path d="M146 128 q6 8 0 16" stroke={ELEC} strokeWidth="2.4" fill="none" strokeLinecap="round" />
          <path d="M260 132 q6 8 0 16" stroke={ELEC} strokeWidth="2.4" fill="none" strokeLinecap="round" />
        </Frame>
      )
    case 'pasta':
      return (
        <Frame id={id} tone="elec">
          <Bowl cx="196" cy="208" rx="100" ry="32" fill={ELEC} stroke={GRAPHITE} />
          <ellipse cx="196" cy="208" rx="100" ry="32" fill={ELEC_PALE} stroke="none" />
          {/* spaghetti strands */}
          <g stroke={ELEC_LIGHT} strokeWidth="3.4" fill="none" strokeLinecap="round">
            <path d="M136 176 q22 -22 52 -8 q30 14 54 -6" />
            <path d="M150 196 q24 -18 52 -4 q28 14 52 -8" />
            <path d="M162 160 q20 -18 46 -8 q26 10 48 -6" />
          </g>
          {/* penne */}
          <g stroke={GRAPHITE} strokeWidth="2" fill={ELEC_PALE}>
          ...
          <circle cx="232" cy="242" r="4" fill={ELEC} />
          <circle cx="264" cy="248" r="4" fill={ELEC} />
          <circle cx="180" cy="246" r="4" fill={ELEC} />
        </Frame>
      )
    case 'canned-foods':
      return (
        <Frame id={id} tone="elec">
          ...
          <rect x="128" y="154" width="44" height="30" rx="4" fill={ELEC_PALE} stroke={ELEC} strokeWidth="1.6" />
          <rect x="196" y="106" width="70" height="126" rx="10" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2.5" />
          ...
          <rect x="290" y="160" width="38" height="34" rx="4" fill={ELEC_PALE} stroke={ELEC} strokeWidth="1.6" />
          {/* tomato + leaf */}
    ...
    case 'honey':
      return (
        <Frame id={id} tone="elec">
          {/* honeycomb */}
          <g stroke={ELEC} strokeWidth="2.2" fill="none">
          ...
          <path d="M318 106 l14 8 0 16 -14 8 -14 -8 0 -16 Z" fill={ELEC_LIGHT} fillOpacity="0.5" />
          {/* jar */}
          <rect x="136" y="118" width="96" height="118" rx="16" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2.5" />
          <rect x="154" y="134" width="60" height="86" rx="10" fill={ELEC_LIGHT} />
          <path d="M158 148 q20 10 52 0" fill="none" stroke={ELEC} strokeWidth="2.4" />
          <path d="M158 190 q20 10 52 0" fill="none" stroke={ELEC} strokeWidth="2.4" />
          ...
          <circle cx="222" cy="182" r="13" fill={ELEC} stroke={GRAPHITE} strokeWidth="2.5" />
          <path d="M212 190 q10 8 20 0 q-4 12 -10 12 q-6 0 -10 -12 Z" fill={ELEC_LIGHT} />
          {/* drip */}
          <path d="M236 224 q-4 18 4 26 q8 8 4 22" fill="none" stroke={ELEC_LIGHT} strokeWidth="4" strokeLinecap="round" />
        </Frame>
      )
    case 'sauces':
      return (
        <Frame id={id} tone="elec">
          ...
          <rect x="114" y="140" width="36" height="46" rx="5" fill={IVORY} stroke={ELEC} strokeWidth="1.8" />
          <circle cx="132" cy="163" r="8" fill="none" stroke={ELEC} strokeWidth="1.8" />
          <rect x="196" y="84" width="62" height="152" rx="16" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2.5" />
          <rect x="216" y="58" width="22" height="30" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2.5" />
          <rect x="208" y="48" width="38" height="14" rx="4" fill={ELEC} />
          <rect x="208" y="128" width="38" height="48" rx="5" fill={IVORY} stroke={ELEC} strokeWidth="1.8" />
          <rect x="218" y="140" width="18" height="24" rx="3" fill={ELEC_LIGHT} />
          {/* herb sprig */}
          <g stroke={GRAPHITE} strokeWidth="2" fill="none">
          ...
          <ellipse cx="300" cy="238" rx="18" ry="6.5" fill={ELEC_LIGHT} />
        </Frame>
      )
    case 'confectionery':
      return (
        <Frame id={id} tone="elec">
          ...
          <ellipse cx="200" cy="210" rx="112" ry="36" fill="none" stroke={ELEC} strokeWidth="1.5" />
          <circle cx="148" cy="178" r="19" fill={ELEC} stroke={GRAPHITE} strokeWidth="2" />
          <path d="M148 178 q-5 -9 5 -11 q10 -2 7 9" fill="none" stroke={IVORY} strokeWidth="2" strokeLinecap="round" />
          <circle cx="196" cy="172" r="17" fill={ELEC_LIGHT} stroke={GRAPHITE} strokeWidth="2" />
          <path d="M196 172 q-5 -8 4 -10 q9 -2 7 8" fill="none" stroke={IVORY} strokeWidth="2" strokeLinecap="round" />
          <circle cx="242" cy="182" r="18" fill={ELEC} stroke={GRAPHITE} strokeWidth="2" />
          ...
          <circle cx="216" cy="212" r="14" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2" />
          <circle cx="222" cy="218" r="5" fill={IVORY} fillOpacity="0.6" />
          <circle cx="250" cy="208" r="13" fill={ELEC} stroke={GRAPHITE} strokeWidth="2" />
          <path d="M250 208 q-4 -7 4 -9 q8 -2 6 7" fill="none" stroke={IVORY} strokeWidth="1.8" strokeLinecap="round" />
          <circle cx="174" cy="238" r="5" fill={ELEC_LIGHT} />
          <circle cx="230" cy="240" r="5" fill={ELEC} />
        </Frame>
      )
    ...
    case 'dates':
      return (
        <Frame id={id} tone="crimson">
          ...
          <ellipse cx="204" cy="216" rx="102" ry="32" fill={ELEC} stroke="none" />
    ...
    case 'tea':
      return (
        <Frame id={id} tone="crimson">
          {/* teapot */}
          <path d="M172 128 q10 -16 44 -16 q34 0 44 16 l14 52 a34 34 0 0 1 -34 40 h-48 a34 34 0 0 1 -34 -40 Z" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2.5" />
          ...
          <ellipse cx="128" cy="210" rx="32" ry="7" fill={ELEC_LIGHT} />
          {/* leaves */}
          <g stroke={GRAPHITE} strokeWidth="2" fill="none">
          ...
          <circle cx="298" cy="238" r="4" fill={ELEC} />
          {/* steam */}
    ...
    case 'dairy':
      return (
        <Frame id={id} tone="crimson">
          {/* cheese wedge */}
          <path d="M136 170 L264 132 L296 214 L168 244 Z" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2.5" strokeLinejoin="round" />
          <path d="M136 170 L264 132 L296 214 L168 244 Z" fill="none" stroke={ELEC} strokeWidth="1.2" strokeLinejoin="round" />
          ...
          {/* cream */}
          <path d="M290 150 q12 8 24 0" fill="none" stroke={ELEC} strokeWidth="3" strokeLinecap="round" />
          <path d="M286 164 q12 8 24 0" fill="none" stroke={ELEC} strokeWidth="3" strokeLinecap="round" />
          <circle cx="314" cy="196" r="8" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="1.8" />
        </Frame>
      )
    case 'frozen-foods':
      return (
        <Frame id={id} tone="elec">
          ...
          <g>
            ...
            <path d="M166 220 L210 182 L252 206 L206 242 Z" fill="#10141a" stroke={GRAPHITE} strokeWidth="2.2" strokeLinejoin="round" />
          ...
          {/* frost dots */}
          <circle cx="130" cy="136" r="3" fill={ELEC_LIGHT} />
          <circle cx="170" cy="122" r="2.4" fill={ELEC_LIGHT} />
          <circle cx="224" cy="130" r="2.6" fill={ELEC_LIGHT} />
          <circle cx="306" cy="226" r="2.6" fill={ELEC_LIGHT} />
          <circle cx="132" cy="240" r="2.4" fill={ELEC_LIGHT} />
        </Frame>
      )
    case 'seafood':
      return (
        <Frame id={id} tone="crimson">
          {/* whole fish */}
          <g>
            <path d="M96 168 q104 -44 190 -6 q-10 26 -36 34 q-4 30 -44 30 q-40 0 -66 -18 q-20 12 -44 -4 Z" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2.5" strokeLinejoin="round" />
          ...
          <path d="M126 230 l20 -8 m-10 16 l20 -8" stroke={ELEC_LIGHT} strokeWidth="2" strokeLinecap="round" />
        </Frame>
      )

    /* fallback guard — never reached, but keeps TS exhaustive */
    default:
      return <Frame id={id} tone="elec"><circle cx="200" cy="150" r="60" fill={ELEC_PALE} stroke={GRAPHITE} strokeWidth="2.5" /></Frame>
  }
}